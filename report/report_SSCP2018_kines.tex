...
% Efforts to CONNECT? Tror jeg leter etter et annet ord her...
...
\subsection*{The Basic Integrate-and-Fire Model} % How detailed should this be? The report should be like a paper, I guess, so I shouldn't need to repeat stuff
...
\begin{table}
 ...
 \begin{tabular}{r|c|r|r|r|r|r|r} % Or something
  Mut. & Unmut. ch. & $\tau$ & $V_{thr}$ & $V_{r}$ & $R$ & $t_r$ & A.D.M.\\
  \hline
  None & 100 \% & $\tau$ & $V_{thr}$ & $V_{r}$ & $R$ & $t_r$ & A.D.M\\ % Insert
 \end{tabular}
